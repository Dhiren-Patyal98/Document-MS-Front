          ...
          <Col span={24}>
            ...
            >
              <Row gutter={24}>
                ...
                <Col span={8}>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please input your Office Gmail!",
                      },
                    ]}
                  >
                    <Input
                      className="myAntIpt2"
                      placeholder="Enter Office Gmail"
                      size="small"
                    />
                  </Form.Item>
                </Col>
                <Col span={8}>
                  <Form.Item
                    label="Office Gmail Password"
                    name="office_gmail_password"
                    rules={[
                      {
                        required: true,
                        message: "Please input your Office Gmail Password!",
                      },
                    ]}
                  >
                    <Input
                      className="myAntIpt2"
                      placeholder="Enter Office Gmail Password"
                      size="small"
                    />
                  </Form.Item>
                </Col>
