                    ...
                    <Col span={12}>
                      ...
                      >
                        ...
                        >
                          ...
                          <Option value="fa-solid fa-facebook">
                            Facebook -{" "}
                          </Option>
                          ...
                          <Option value="fa-solid fa-truck-fast">
                            Twitter -
                          </Option>
      ...
      >
        {getAcountdata.map((x) => (
          <Card key={x._id} className="card_style">
            ...
            <img
              className="set_img"
              src={`${process.env.REACT_APP_API_URL}/images/${x.img}`}
            />

            <p className="client_name">
              <Link to={`/account-details/${x._id}`}>{x.client_name}</Link>
            </p>
